...
**Last Updated:** 2026-01-16 16:19:35 UTC
...
|-------|-----------|-------|------|----------|-----------|--------|-------|
| int_attributed_purchases | order_dt | 2025-10-09 | 818 | 1 | - | ✅ PASS | - |
| int_cart_attribution | cart_dt | 2025-10-09 | 5,939 | 1 | - | ⚠️ WARN | semantic_checks_failed |
| int_inventory_risk | ingest_dt | 2025-10-09 | 3,000 | 1 | - | ✅ PASS | - |
| int_customer_retention_signals | ingest_dt | 2025-10-09 | 6,412 | 1 | - | ✅ PASS | - |
| int_customer_lifetime_value | ingest_dt | 2025-10-09 | 6,412 | 1 | - | ✅ PASS | - |
| int_daily_business_metrics | date | 2025-10-09 | 1 | 1 | - | ⚠️ WARN | semantic_checks_failed |
| int_product_performance | product_dt | 2025-10-09 | 2,996 | 1 | - | ⚠️ WARN | sanity_checks_failed, semantic_checks_failed |
| int_sales_velocity | order_dt | 2025-10-09 | 2,175 | 1 | - | ✅ PASS | - |
| int_regional_financials | order_dt | 2025-10-09 | 818 | 1 | - | ✅ PASS | - |
| int_shipping_economics | order_dt | 2025-10-09 | 818 | 1 | - | ✅ PASS | - |
...
- **Partition:** cart_dt=2025-10-09
- **Rows:** 5,939
- **Min Rows:** 1
- **Notes:** semantic_checks_failed

### ⚠️ int_daily_business_metrics
- **Partition:** date=2025-10-09
- **Rows:** 1
- **Min Rows:** 1
- **Notes:** semantic_checks_failed

### ⚠️ int_product_performance
- **Partition:** product_dt=2025-10-09
- **Rows:** 2,996
- **Min Rows:** 1
...
**Semantic Issues:** abandoned_value_positive_for_abandoned: 788 rows
...
**Sanity Issues:** return_rate: 20 outside_0_1, cart_to_order_rate: 1 outside_0_1

**Semantic Issues:** units_returned_le_units_sold: 60 rows, return_rate_le_one: 20 rows, cart_to_order_rate_le_one: 1 rows
