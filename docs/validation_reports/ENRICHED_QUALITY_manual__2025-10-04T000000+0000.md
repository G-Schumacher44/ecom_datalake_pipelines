...
**Last Updated:** 2026-01-17 05:28:13 UTC
...
|-------|-----------|-------|------|----------|-----------|--------|-------|
| int_attributed_purchases | order_dt | 2025-10-04 | 751 | 1 | - | ✅ PASS | - |
| int_cart_attribution | cart_dt | 2025-10-04 | 5,301 | 1 | - | ⚠️ WARN | semantic_checks_failed |
| int_inventory_risk | ingest_dt | 2025-10-04 | 3,000 | 1 | - | ✅ PASS | - |
| int_customer_retention_signals | ingest_dt | 2025-10-04 | 6,412 | 1 | - | ✅ PASS | - |
| int_customer_lifetime_value | ingest_dt | 2025-10-04 | 6,412 | 1 | - | ✅ PASS | - |
| int_daily_business_metrics | date | 2025-10-04 | 1 | 1 | - | ⚠️ WARN | semantic_checks_failed |
| int_product_performance | product_dt | 2025-10-04 | 2,996 | 1 | - | ⚠️ WARN | sanity_checks_failed, semantic_checks_failed |
| int_sales_velocity | order_dt | 2025-10-04 | 2,138 | 1 | - | ✅ PASS | - |
| int_regional_financials | order_dt | 2025-10-04 | 751 | 1 | - | ✅ PASS | - |
| int_shipping_economics | order_dt | 2025-10-04 | 751 | 1 | - | ✅ PASS | - |
...
- **Partition:** cart_dt=2025-10-04
- **Rows:** 5,301
- **Min Rows:** 1
- **Notes:** semantic_checks_failed

### ⚠️ int_daily_business_metrics
- **Partition:** date=2025-10-04
- **Rows:** 1
- **Min Rows:** 1
- **Notes:** semantic_checks_failed

### ⚠️ int_product_performance
- **Partition:** product_dt=2025-10-04
- **Rows:** 2,996
- **Min Rows:** 1
...
**Semantic Issues:** abandoned_value_positive_for_abandoned: 690 rows
...
**Sanity Issues:** return_rate: 8 outside_0_1

**Semantic Issues:** units_returned_le_units_sold: 16 rows, return_rate_le_one: 8 rows
